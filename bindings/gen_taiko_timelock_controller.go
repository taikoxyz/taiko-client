...
func (_TaikoTimelockController *TaikoTimelockControllerCaller) Resolve(opts *bind.CallOpts, chainId uint64, name [32]byte, allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _TaikoTimelockController.contract.Call(opts, &out, "resolve", chainId, name, allowZeroAddress)
...
//
// Solidity: function resolve(uint64 chainId, bytes32 name, bool allowZeroAddress) view returns(address addr)
func (_TaikoTimelockController *TaikoTimelockControllerSession) Resolve(chainId uint64, name [32]byte, allowZeroAddress bool) (common.Address, error) {
	return _TaikoTimelockController.Contract.Resolve(&_TaikoTimelockController.CallOpts, chainId, name, allowZeroAddress)
}

// Resolve is a free data retrieval call binding the contract method 0x3eb6b8cf.
//
// Solidity: function resolve(uint64 chainId, bytes32 name, bool allowZeroAddress) view returns(address addr)
func (_TaikoTimelockController *TaikoTimelockControllerCallerSession) Resolve(chainId uint64, name [32]byte, allowZeroAddress bool) (common.Address, error) {
	return _TaikoTimelockController.Contract.Resolve(&_TaikoTimelockController.CallOpts, chainId, name, allowZeroAddress)
}
...
func (_TaikoTimelockController *TaikoTimelockControllerCaller) Resolve0(opts *bind.CallOpts, name [32]byte, allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _TaikoTimelockController.contract.Call(opts, &out, "resolve0", name, allowZeroAddress)
...
//
// Solidity: function resolve(bytes32 name, bool allowZeroAddress) view returns(address addr)
func (_TaikoTimelockController *TaikoTimelockControllerSession) Resolve0(name [32]byte, allowZeroAddress bool) (common.Address, error) {
	return _TaikoTimelockController.Contract.Resolve0(&_TaikoTimelockController.CallOpts, name, allowZeroAddress)
}

// Resolve0 is a free data retrieval call binding the contract method 0xa86f9d9e.
//
// Solidity: function resolve(bytes32 name, bool allowZeroAddress) view returns(address addr)
func (_TaikoTimelockController *TaikoTimelockControllerCallerSession) Resolve0(name [32]byte, allowZeroAddress bool) (common.Address, error) {
	return _TaikoTimelockController.Contract.Resolve0(&_TaikoTimelockController.CallOpts, name, allowZeroAddress)
}
...
//
// Solidity: function init(address _owner, uint256 minDelay) returns()
func (_TaikoTimelockController *TaikoTimelockControllerTransactor) Init(opts *bind.TransactOpts, _owner common.Address, minDelay *big.Int) (*types.Transaction, error) {
	return _TaikoTimelockController.contract.Transact(opts, "init", _owner, minDelay)
}

// Init is a paid mutator transaction binding the contract method 0x399ae724.
//
// Solidity: function init(address _owner, uint256 minDelay) returns()
func (_TaikoTimelockController *TaikoTimelockControllerSession) Init(_owner common.Address, minDelay *big.Int) (*types.Transaction, error) {
	return _TaikoTimelockController.Contract.Init(&_TaikoTimelockController.TransactOpts, _owner, minDelay)
}

// Init is a paid mutator transaction binding the contract method 0x399ae724.
//
// Solidity: function init(address _owner, uint256 minDelay) returns()
func (_TaikoTimelockController *TaikoTimelockControllerTransactorSession) Init(_owner common.Address, minDelay *big.Int) (*types.Transaction, error) {
	return _TaikoTimelockController.Contract.Init(&_TaikoTimelockController.TransactOpts, _owner, minDelay)
}
