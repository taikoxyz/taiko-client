...
//
// Solidity: function getBlock(uint64 blockId) view returns(bytes32 _metaHash, uint64 _proposedAt, address _prover, uint16 _nextForkChoiceId, uint16 _verifiedForkChoiceId)
func (_TaikoL1Client *TaikoL1ClientCaller) GetBlock(opts *bind.CallOpts, blockId uint64) (struct {
	MetaHash             [32]byte
	ProposedAt           uint64
	Prover               common.Address
	...
	outstruct.ProposedAt = *abi.ConvertType(out[1], new(uint64)).(*uint64)
	outstruct.Prover = *abi.ConvertType(out[2], new(common.Address)).(*common.Address)
	outstruct.NextForkChoiceId = *abi.ConvertType(out[3], new(uint16)).(*uint16)
	outstruct.VerifiedForkChoiceId = *abi.ConvertType(out[4], new(uint16)).(*uint16)
...
//
// Solidity: function getBlock(uint64 blockId) view returns(bytes32 _metaHash, uint64 _proposedAt, address _prover, uint16 _nextForkChoiceId, uint16 _verifiedForkChoiceId)
func (_TaikoL1Client *TaikoL1ClientSession) GetBlock(blockId uint64) (struct {
	MetaHash             [32]byte
	ProposedAt           uint64
	Prover               common.Address
	NextForkChoiceId     uint16
...
//
// Solidity: function getBlock(uint64 blockId) view returns(bytes32 _metaHash, uint64 _proposedAt, address _prover, uint16 _nextForkChoiceId, uint16 _verifiedForkChoiceId)
func (_TaikoL1Client *TaikoL1ClientCallerSession) GetBlock(blockId uint64) (struct {
	MetaHash             [32]byte
	ProposedAt           uint64
	Prover               common.Address
	NextForkChoiceId     uint16
...
//
// Solidity: function getConfig() pure returns((uint256,bool,uint64,uint64,uint64,uint32,uint32,uint64,uint64,uint256,uint256,uint256,uint256,uint256,uint16,uint96,bool,uint256,uint64,uint64,uint96,uint96,uint256,uint256))
...
// GetForkChoice is a free data retrieval call binding the contract method 0x6dccc02a.
//
// Solidity: function getForkChoice(uint64 blockId, bytes32 parentHash, uint32 parentGasUsed) view returns((bytes32,bytes32,bytes32,address,uint64,uint32))
func (_TaikoL1Client *TaikoL1ClientCaller) GetForkChoice(opts *bind.CallOpts, blockId uint64, parentHash [32]byte, parentGasUsed uint32) (TaikoDataForkChoice, error) {
	var out []interface{}
...
//
// Solidity: function getForkChoice(uint64 blockId, bytes32 parentHash, uint32 parentGasUsed) view returns((bytes32,bytes32,bytes32,address,uint64,uint32))
func (_TaikoL1Client *TaikoL1ClientSession) GetForkChoice(blockId uint64, parentHash [32]byte, parentGasUsed uint32) (TaikoDataForkChoice, error) {
...
//
// Solidity: function getForkChoice(uint64 blockId, bytes32 parentHash, uint32 parentGasUsed) view returns((bytes32,bytes32,bytes32,address,uint64,uint32))
func (_TaikoL1Client *TaikoL1ClientCallerSession) GetForkChoice(blockId uint64, parentHash [32]byte, parentGasUsed uint32) (TaikoDataForkChoice, error) {
	return _TaikoL1Client.Contract.GetForkChoice(&_TaikoL1Client.CallOpts, blockId, parentHash, parentGasUsed)
}
