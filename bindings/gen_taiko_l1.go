...
//
// Solidity: function getBlock(uint256 blockId) view returns(bytes32 _metaHash, uint24 _nextForkChoiceId, uint24 _verifiedForkChoiceId, bool _proverReleased, address _proposer, uint32 _feePerGas, uint64 _proposedAt, address _assignedProver, uint32 _rewardPerGas, uint64 _proofWindow)
func (_TaikoL1Client *TaikoL1ClientCaller) GetBlock(opts *bind.CallOpts, blockId *big.Int) (struct {
	...
	outstruct.NextForkChoiceId = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
	outstruct.VerifiedForkChoiceId = *abi.ConvertType(out[2], new(*big.Int)).(**big.Int)
	outstruct.ProverReleased = *abi.ConvertType(out[3], new(bool)).(*bool)
	outstruct.Proposer = *abi.ConvertType(out[4], new(common.Address)).(*common.Address)
	outstruct.FeePerGas = *abi.ConvertType(out[5], new(uint32)).(*uint32)
	outstruct.ProposedAt = *abi.ConvertType(out[6], new(uint64)).(*uint64)
	outstruct.AssignedProver = *abi.ConvertType(out[7], new(common.Address)).(*common.Address)
	outstruct.RewardPerGas = *abi.ConvertType(out[8], new(uint32)).(*uint32)
	outstruct.ProofWindow = *abi.ConvertType(out[9], new(uint64)).(*uint64)
...
//
// Solidity: function getConfig() pure returns((uint256,bool,uint256,uint256,uint256,uint32,uint32,uint32,uint32,uint32,uint256,uint256,uint256,uint16,uint16,uint16,uint256,uint64,uint64,uint96,uint96,uint256,uint256,uint8,uint32,uint32))
...
//
// Solidity: function proposeBlock(bytes input, bytes txList) returns((uint64,uint64,uint64,bytes32,bytes32,bytes32,uint24,uint24,address,address,(address,uint96,uint64)[]) meta)
...
// FilterBlockProposed is a free log retrieval operation binding the contract event 0x5efa83e93bb1ea084e08ade0b05e38c73cf985e7357a9ec267d2449e7bcd6536.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint32 rewardPerGas, uint64 feePerGas, (uint64,uint64,uint64,bytes32,bytes32,bytes32,uint24,uint24,address,address,(address,uint96,uint64)[]) meta)
...
// WatchBlockProposed is a free log subscription operation binding the contract event 0x5efa83e93bb1ea084e08ade0b05e38c73cf985e7357a9ec267d2449e7bcd6536.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint32 rewardPerGas, uint64 feePerGas, (uint64,uint64,uint64,bytes32,bytes32,bytes32,uint24,uint24,address,address,(address,uint96,uint64)[]) meta)
...
// ParseBlockProposed is a log parse operation binding the contract event 0x5efa83e93bb1ea084e08ade0b05e38c73cf985e7357a9ec267d2449e7bcd6536.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint32 rewardPerGas, uint64 feePerGas, (uint64,uint64,uint64,bytes32,bytes32,bytes32,uint24,uint24,address,address,(address,uint96,uint64)[]) meta)
...
// FilterBlockProposed0 is a free log retrieval operation binding the contract event 0x5efa83e93bb1ea084e08ade0b05e38c73cf985e7357a9ec267d2449e7bcd6536.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint32 rewardPerGas, uint64 feePerGas, (uint64,uint64,uint64,bytes32,bytes32,bytes32,uint24,uint24,address,address,(address,uint96,uint64)[]) meta)
...
// WatchBlockProposed0 is a free log subscription operation binding the contract event 0x5efa83e93bb1ea084e08ade0b05e38c73cf985e7357a9ec267d2449e7bcd6536.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint32 rewardPerGas, uint64 feePerGas, (uint64,uint64,uint64,bytes32,bytes32,bytes32,uint24,uint24,address,address,(address,uint96,uint64)[]) meta)
...
// ParseBlockProposed0 is a log parse operation binding the contract event 0x5efa83e93bb1ea084e08ade0b05e38c73cf985e7357a9ec267d2449e7bcd6536.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint32 rewardPerGas, uint64 feePerGas, (uint64,uint64,uint64,bytes32,bytes32,bytes32,uint24,uint24,address,address,(address,uint96,uint64)[]) meta)
...
func (_TaikoL1Client *TaikoL1ClientFilterer) FilterBlockVerified(opts *bind.FilterOpts, blockId []*big.Int) (*TaikoL1ClientBlockVerifiedIterator, error) {
	...
	logs, sub, err := _TaikoL1Client.contract.FilterLogs(opts, "BlockVerified", blockIdRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event BlockVerified(uint256 indexed blockId, bytes32 blockHash, address prover, uint64 blockFee, uint64 proofReward)
func (_TaikoL1Client *TaikoL1ClientFilterer) WatchBlockVerified(opts *bind.WatchOpts, sink chan<- *TaikoL1ClientBlockVerified, blockId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _TaikoL1Client.contract.WatchLogs(opts, "BlockVerified", blockIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
//
// Solidity: event BlockVerified(uint256 indexed blockId, bytes32 blockHash, address prover, uint64 blockFee, uint64 proofReward)
func (_TaikoL1Client *TaikoL1ClientFilterer) FilterBlockVerified0(opts *bind.FilterOpts, blockId []*big.Int) (*TaikoL1ClientBlockVerified0Iterator, error) {
	...
	logs, sub, err := _TaikoL1Client.contract.FilterLogs(opts, "BlockVerified0", blockIdRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event BlockVerified(uint256 indexed blockId, bytes32 blockHash, address prover, uint64 blockFee, uint64 proofReward)
func (_TaikoL1Client *TaikoL1ClientFilterer) WatchBlockVerified0(opts *bind.WatchOpts, sink chan<- *TaikoL1ClientBlockVerified0, blockId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _TaikoL1Client.contract.WatchLogs(opts, "BlockVerified0", blockIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
