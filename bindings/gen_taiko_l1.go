...
func (_TaikoL1Client *TaikoL1ClientFilterer) FilterCrossChainSynced0(opts *bind.FilterOpts, remoteBlockId []uint64) (*TaikoL1ClientCrossChainSynced0Iterator, error) {
	...
	logs, sub, err := _TaikoL1Client.contract.FilterLogs(opts, "CrossChainSynced0", remoteBlockIdRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event CrossChainSynced(uint64 indexed remoteBlockId, uint64 syncedInBlock, bytes32 blockHash, bytes32 signalRoot)
func (_TaikoL1Client *TaikoL1ClientFilterer) WatchCrossChainSynced0(opts *bind.WatchOpts, sink chan<- *TaikoL1ClientCrossChainSynced0, remoteBlockId []uint64) (event.Subscription, error) {
	...
	logs, sub, err := _TaikoL1Client.contract.WatchLogs(opts, "CrossChainSynced0", remoteBlockIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
