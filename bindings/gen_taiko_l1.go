...
// ProposeBlock is a paid mutator transaction binding the contract method 0x9dbdb99d.
//
// Solidity: function proposeBlock(bytes32 txListHash, bytes assignment, bytes txList) payable returns((bytes32,bytes32,bytes32,uint64,uint64,uint64,uint32,address,(address,uint96,uint64)[]) meta)
func (_TaikoL1Client *TaikoL1ClientTransactor) ProposeBlock(opts *bind.TransactOpts, txListHash [32]byte, assignment []byte, txList []byte) (*types.Transaction, error) {
	return _TaikoL1Client.contract.Transact(opts, "proposeBlock", txListHash, assignment, txList)
}

// ProposeBlock is a paid mutator transaction binding the contract method 0x9dbdb99d.
//
// Solidity: function proposeBlock(bytes32 txListHash, bytes assignment, bytes txList) payable returns((bytes32,bytes32,bytes32,uint64,uint64,uint64,uint32,address,(address,uint96,uint64)[]) meta)
func (_TaikoL1Client *TaikoL1ClientSession) ProposeBlock(txListHash [32]byte, assignment []byte, txList []byte) (*types.Transaction, error) {
	return _TaikoL1Client.Contract.ProposeBlock(&_TaikoL1Client.TransactOpts, txListHash, assignment, txList)
}

// ProposeBlock is a paid mutator transaction binding the contract method 0x9dbdb99d.
//
// Solidity: function proposeBlock(bytes32 txListHash, bytes assignment, bytes txList) payable returns((bytes32,bytes32,bytes32,uint64,uint64,uint64,uint32,address,(address,uint96,uint64)[]) meta)
func (_TaikoL1Client *TaikoL1ClientTransactorSession) ProposeBlock(txListHash [32]byte, assignment []byte, txList []byte) (*types.Transaction, error) {
	return _TaikoL1Client.Contract.ProposeBlock(&_TaikoL1Client.TransactOpts, txListHash, assignment, txList)
}
...
// FilterBlockProposed is a free log retrieval operation binding the contract event 0x26243d4c335230f74fc3472f2c10f44e8d055c3107473e90be831fcbfe70d889.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, uint256 proverFee, uint256 reward, (bytes32,bytes32,bytes32,uint64,uint64,uint64,uint32,address,(address,uint96,uint64)[]) meta)
...
// WatchBlockProposed is a free log subscription operation binding the contract event 0x26243d4c335230f74fc3472f2c10f44e8d055c3107473e90be831fcbfe70d889.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, uint256 proverFee, uint256 reward, (bytes32,bytes32,bytes32,uint64,uint64,uint64,uint32,address,(address,uint96,uint64)[]) meta)
...
// ParseBlockProposed is a log parse operation binding the contract event 0x26243d4c335230f74fc3472f2c10f44e8d055c3107473e90be831fcbfe70d889.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, uint256 proverFee, uint256 reward, (bytes32,bytes32,bytes32,uint64,uint64,uint64,uint32,address,(address,uint96,uint64)[]) meta)
...
// FilterBlockProposed0 is a free log retrieval operation binding the contract event 0x26243d4c335230f74fc3472f2c10f44e8d055c3107473e90be831fcbfe70d889.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, uint256 proverFee, uint256 reward, (bytes32,bytes32,bytes32,uint64,uint64,uint64,uint32,address,(address,uint96,uint64)[]) meta)
...
// WatchBlockProposed0 is a free log subscription operation binding the contract event 0x26243d4c335230f74fc3472f2c10f44e8d055c3107473e90be831fcbfe70d889.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, uint256 proverFee, uint256 reward, (bytes32,bytes32,bytes32,uint64,uint64,uint64,uint32,address,(address,uint96,uint64)[]) meta)
...
// ParseBlockProposed0 is a log parse operation binding the contract event 0x26243d4c335230f74fc3472f2c10f44e8d055c3107473e90be831fcbfe70d889.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, uint256 proverFee, uint256 reward, (bytes32,bytes32,bytes32,uint64,uint64,uint64,uint32,address,(address,uint96,uint64)[]) meta)
