...
//
// Solidity: function getConfig() pure returns((uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint64,uint64,uint96,uint96,uint64,uint8,bool))
...
func (_TaikoL1Client *TaikoL1ClientCaller) GetVerifierName(opts *bind.CallOpts, id uint16) (string, error) {
	var out []interface{}
...
//
// Solidity: function getVerifierName(uint16 id) pure returns(string)
func (_TaikoL1Client *TaikoL1ClientSession) GetVerifierName(id uint16) (string, error) {
...
//
// Solidity: function getVerifierName(uint16 id) pure returns(string)
func (_TaikoL1Client *TaikoL1ClientCallerSession) GetVerifierName(id uint16) (string, error) {
	return _TaikoL1Client.Contract.GetVerifierName(&_TaikoL1Client.CallOpts, id)
}
