...
// GetOracleProver is a free data retrieval call binding the contract method 0x6287f325.
//
// Solidity: function getOracleProver() view returns(address)
func (_TaikoL1Client *TaikoL1ClientCaller) GetOracleProver(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TaikoL1Client.contract.Call(opts, &out, "getOracleProver")
...
//
// Solidity: function getOracleProver() view returns(address)
func (_TaikoL1Client *TaikoL1ClientSession) GetOracleProver() (common.Address, error) {
	return _TaikoL1Client.Contract.GetOracleProver(&_TaikoL1Client.CallOpts)
}

// GetOracleProver is a free data retrieval call binding the contract method 0x6287f325.
//
// Solidity: function getOracleProver() view returns(address)
func (_TaikoL1Client *TaikoL1ClientCallerSession) GetOracleProver() (common.Address, error) {
	return _TaikoL1Client.Contract.GetOracleProver(&_TaikoL1Client.CallOpts)
}
...
// FilterBlockProven is a free log retrieval operation binding the contract event 0xabbd51d3dd714b3fb269b9806a045c65946ea52a31e1f0ea3e94d8dd1a1b6f5c.
//
// Solidity: event BlockProven(uint256 indexed id, bytes32 parentHash, bytes32 blockHash, bytes32 signalRoot, address prover, uint32 parentGasUsed, uint32 gasUsed)
...
// WatchBlockProven is a free log subscription operation binding the contract event 0xabbd51d3dd714b3fb269b9806a045c65946ea52a31e1f0ea3e94d8dd1a1b6f5c.
//
// Solidity: event BlockProven(uint256 indexed id, bytes32 parentHash, bytes32 blockHash, bytes32 signalRoot, address prover, uint32 parentGasUsed, uint32 gasUsed)
...
// ParseBlockProven is a log parse operation binding the contract event 0xabbd51d3dd714b3fb269b9806a045c65946ea52a31e1f0ea3e94d8dd1a1b6f5c.
//
// Solidity: event BlockProven(uint256 indexed id, bytes32 parentHash, bytes32 blockHash, bytes32 signalRoot, address prover, uint32 parentGasUsed, uint32 gasUsed)
