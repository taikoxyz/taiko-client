...
// LibProvingEvidence is an auto generated low-level Go binding around an user-defined struct.
type LibProvingEvidence struct {
...
// GetInstance is a free data retrieval call binding the contract method 0x51d8f3f3.
//
// Solidity: function getInstance(((uint256,uint256,bytes32,address,bytes32,bytes32,bytes,uint64,uint64,uint64,uint64),(bytes32,bytes32,address,bytes32,bytes32,bytes32,bytes32[8],uint256,uint128,uint64,uint64,uint64,bytes,bytes32,uint64,uint256),address,bytes[],uint16[]) evidence) pure returns(bytes32 instance)
func (_TaikoL1Client *TaikoL1ClientCaller) GetInstance(opts *bind.CallOpts, evidence LibProvingEvidence) ([32]byte, error) {
	var out []interface{}
	err := _TaikoL1Client.contract.Call(opts, &out, "getInstance", evidence)
...
//
// Solidity: function getInstance(((uint256,uint256,bytes32,address,bytes32,bytes32,bytes,uint64,uint64,uint64,uint64),(bytes32,bytes32,address,bytes32,bytes32,bytes32,bytes32[8],uint256,uint128,uint64,uint64,uint64,bytes,bytes32,uint64,uint256),address,bytes[],uint16[]) evidence) pure returns(bytes32 instance)
func (_TaikoL1Client *TaikoL1ClientSession) GetInstance(evidence LibProvingEvidence) ([32]byte, error) {
	return _TaikoL1Client.Contract.GetInstance(&_TaikoL1Client.CallOpts, evidence)
}

// GetInstance is a free data retrieval call binding the contract method 0x51d8f3f3.
//
// Solidity: function getInstance(((uint256,uint256,bytes32,address,bytes32,bytes32,bytes,uint64,uint64,uint64,uint64),(bytes32,bytes32,address,bytes32,bytes32,bytes32,bytes32[8],uint256,uint128,uint64,uint64,uint64,bytes,bytes32,uint64,uint256),address,bytes[],uint16[]) evidence) pure returns(bytes32 instance)
func (_TaikoL1Client *TaikoL1ClientCallerSession) GetInstance(evidence LibProvingEvidence) ([32]byte, error) {
	return _TaikoL1Client.Contract.GetInstance(&_TaikoL1Client.CallOpts, evidence)
}
