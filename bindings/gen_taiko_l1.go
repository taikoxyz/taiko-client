...
// TaikoL1ClientTaikoTokenSnapshotIterator is returned from FilterTaikoTokenSnapshot and is used to iterate over the raw logs and unpacked data for TaikoTokenSnapshot events raised by the TaikoL1Client contract.
type TaikoL1ClientTaikoTokenSnapshotIterator struct {
	Event *TaikoL1ClientTaikoTokenSnapshot // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TaikoL1ClientTaikoTokenSnapshotIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TaikoL1ClientTaikoTokenSnapshot)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TaikoL1ClientTaikoTokenSnapshotIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TaikoL1ClientTaikoTokenSnapshotIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TaikoL1ClientTaikoTokenSnapshot represents a TaikoTokenSnapshot event raised by the TaikoL1Client contract.
type TaikoL1ClientTaikoTokenSnapshot struct {
...
func (_TaikoL1Client *TaikoL1ClientFilterer) FilterTaikoTokenSnapshot(opts *bind.FilterOpts) (*TaikoL1ClientTaikoTokenSnapshotIterator, error) {

	logs, sub, err := _TaikoL1Client.contract.FilterLogs(opts, "TaikoTokenSnapshot")
	if err != nil {
		return nil, err
	}
	return &TaikoL1ClientTaikoTokenSnapshotIterator{contract: _TaikoL1Client.contract, event: "TaikoTokenSnapshot", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TaikoTokenSnapshot(address tkoAddress, uint256 snapshotIdx, uint256 snapshotId)
func (_TaikoL1Client *TaikoL1ClientFilterer) WatchTaikoTokenSnapshot(opts *bind.WatchOpts, sink chan<- *TaikoL1ClientTaikoTokenSnapshot) (event.Subscription, error) {

	logs, sub, err := _TaikoL1Client.contract.WatchLogs(opts, "TaikoTokenSnapshot")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TaikoL1ClientTaikoTokenSnapshot)
				if err := _TaikoL1Client.contract.UnpackLog(event, "TaikoTokenSnapshot", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TaikoTokenSnapshot(address tkoAddress, uint256 snapshotIdx, uint256 snapshotId)
func (_TaikoL1Client *TaikoL1ClientFilterer) ParseTaikoTokenSnapshot(log types.Log) (*TaikoL1ClientTaikoTokenSnapshot, error) {
	event := new(TaikoL1ClientTaikoTokenSnapshot)
	if err := _TaikoL1Client.contract.UnpackLog(event, "TaikoTokenSnapshot", log); err != nil {
		return nil, err
	}
...
// TaikoL1ClientTaikoTokenSnapshot0Iterator is returned from FilterTaikoTokenSnapshot0 and is used to iterate over the raw logs and unpacked data for TaikoTokenSnapshot0 events raised by the TaikoL1Client contract.
type TaikoL1ClientTaikoTokenSnapshot0Iterator struct {
	Event *TaikoL1ClientTaikoTokenSnapshot0 // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TaikoL1ClientTaikoTokenSnapshot0Iterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TaikoL1ClientTaikoTokenSnapshot0)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TaikoL1ClientTaikoTokenSnapshot0Iterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TaikoL1ClientTaikoTokenSnapshot0Iterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TaikoL1ClientTaikoTokenSnapshot0 represents a TaikoTokenSnapshot0 event raised by the TaikoL1Client contract.
type TaikoL1ClientTaikoTokenSnapshot0 struct {
	TkoAddress  common.Address
	SnapshotIdx *big.Int
	SnapshotId  *big.Int
	Raw         types.Log // Blockchain specific contextual infos
...
//
// Solidity: event TaikoTokenSnapshot(address tkoAddress, uint256 snapshotIdx, uint256 snapshotId)
func (_TaikoL1Client *TaikoL1ClientFilterer) FilterTaikoTokenSnapshot0(opts *bind.FilterOpts) (*TaikoL1ClientTaikoTokenSnapshot0Iterator, error) {

	logs, sub, err := _TaikoL1Client.contract.FilterLogs(opts, "TaikoTokenSnapshot0")
	if err != nil {
		return nil, err
	}
	return &TaikoL1ClientTaikoTokenSnapshot0Iterator{contract: _TaikoL1Client.contract, event: "TaikoTokenSnapshot0", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TaikoTokenSnapshot(address tkoAddress, uint256 snapshotIdx, uint256 snapshotId)
func (_TaikoL1Client *TaikoL1ClientFilterer) WatchTaikoTokenSnapshot0(opts *bind.WatchOpts, sink chan<- *TaikoL1ClientTaikoTokenSnapshot0) (event.Subscription, error) {

	logs, sub, err := _TaikoL1Client.contract.WatchLogs(opts, "TaikoTokenSnapshot0")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TaikoL1ClientTaikoTokenSnapshot0)
				if err := _TaikoL1Client.contract.UnpackLog(event, "TaikoTokenSnapshot0", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TaikoTokenSnapshot(address tkoAddress, uint256 snapshotIdx, uint256 snapshotId)
func (_TaikoL1Client *TaikoL1ClientFilterer) ParseTaikoTokenSnapshot0(log types.Log) (*TaikoL1ClientTaikoTokenSnapshot0, error) {
	event := new(TaikoL1ClientTaikoTokenSnapshot0)
	if err := _TaikoL1Client.contract.UnpackLog(event, "TaikoTokenSnapshot0", log); err != nil {
		return nil, err
	}
