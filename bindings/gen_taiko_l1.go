...
//
// Solidity: function init(address _owner, address _addressManager, bytes32 _genesisBlockHash, bool _pause) returns()
func (_TaikoL1Client *TaikoL1ClientTransactor) Init(opts *bind.TransactOpts, _owner common.Address, _addressManager common.Address, _genesisBlockHash [32]byte, _pause bool) (*types.Transaction, error) {
	return _TaikoL1Client.contract.Transact(opts, "init", _owner, _addressManager, _genesisBlockHash, _pause)
}

// Init is a paid mutator transaction binding the contract method 0x29d1b62f.
//
// Solidity: function init(address _owner, address _addressManager, bytes32 _genesisBlockHash, bool _pause) returns()
func (_TaikoL1Client *TaikoL1ClientSession) Init(_owner common.Address, _addressManager common.Address, _genesisBlockHash [32]byte, _pause bool) (*types.Transaction, error) {
	return _TaikoL1Client.Contract.Init(&_TaikoL1Client.TransactOpts, _owner, _addressManager, _genesisBlockHash, _pause)
}

// Init is a paid mutator transaction binding the contract method 0x29d1b62f.
//
// Solidity: function init(address _owner, address _addressManager, bytes32 _genesisBlockHash, bool _pause) returns()
func (_TaikoL1Client *TaikoL1ClientTransactorSession) Init(_owner common.Address, _addressManager common.Address, _genesisBlockHash [32]byte, _pause bool) (*types.Transaction, error) {
	return _TaikoL1Client.Contract.Init(&_TaikoL1Client.TransactOpts, _owner, _addressManager, _genesisBlockHash, _pause)
}
