...
// IsConfigValid is a free data retrieval call binding the contract method 0x7e10e12f.
//
// Solidity: function isConfigValid((uint64,uint64,uint64,uint64,uint32,uint24,uint24,bool,bool,uint96,uint256,uint64,uint64,uint96,uint96,uint256,uint256,uint8) config) view returns(bool isValid)
