...
// Approve is a paid mutator transaction binding the contract method 0x9238bccf.
//
// Solidity: function approve((bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint24,uint24,uint16,bool,bytes32) meta, (bytes32,bytes32,bytes32,bytes32,bytes32[2]) tran, (uint16,bytes) proof) returns(bool approved)
