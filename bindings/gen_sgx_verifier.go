...
// GetSignedHash is a free data retrieval call binding the contract method 0x01763903.
//
// Solidity: function getSignedHash((bytes32,bytes32,bytes32,bytes32) _tran, address _newInstance, address _prover, bytes32 _metaHash) view returns(bytes32)
func (_SgxVerifier *SgxVerifierCaller) GetSignedHash(opts *bind.CallOpts, _tran TaikoDataTransition, _newInstance common.Address, _prover common.Address, _metaHash [32]byte) ([32]byte, error) {
	var out []interface{}
	err := _SgxVerifier.contract.Call(opts, &out, "getSignedHash", _tran, _newInstance, _prover, _metaHash)
...
//
// Solidity: function getSignedHash((bytes32,bytes32,bytes32,bytes32) _tran, address _newInstance, address _prover, bytes32 _metaHash) view returns(bytes32)
func (_SgxVerifier *SgxVerifierSession) GetSignedHash(_tran TaikoDataTransition, _newInstance common.Address, _prover common.Address, _metaHash [32]byte) ([32]byte, error) {
	return _SgxVerifier.Contract.GetSignedHash(&_SgxVerifier.CallOpts, _tran, _newInstance, _prover, _metaHash)
}

// GetSignedHash is a free data retrieval call binding the contract method 0x01763903.
//
// Solidity: function getSignedHash((bytes32,bytes32,bytes32,bytes32) _tran, address _newInstance, address _prover, bytes32 _metaHash) view returns(bytes32)
func (_SgxVerifier *SgxVerifierCallerSession) GetSignedHash(_tran TaikoDataTransition, _newInstance common.Address, _prover common.Address, _metaHash [32]byte) ([32]byte, error) {
	return _SgxVerifier.Contract.GetSignedHash(&_SgxVerifier.CallOpts, _tran, _newInstance, _prover, _metaHash)
}
