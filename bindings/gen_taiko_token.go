...
func (_TaikoToken *TaikoTokenCaller) CurrentSnapshotId(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _TaikoToken.contract.Call(opts, &out, "currentSnapshotId")
...
//
// Solidity: function currentSnapshotId() view returns(uint256)
func (_TaikoToken *TaikoTokenSession) CurrentSnapshotId() (*big.Int, error) {
	return _TaikoToken.Contract.CurrentSnapshotId(&_TaikoToken.CallOpts)
}

// CurrentSnapshotId is a free data retrieval call binding the contract method 0x970875ce.
//
// Solidity: function currentSnapshotId() view returns(uint256)
func (_TaikoToken *TaikoTokenCallerSession) CurrentSnapshotId() (*big.Int, error) {
	return _TaikoToken.Contract.CurrentSnapshotId(&_TaikoToken.CallOpts)
}
