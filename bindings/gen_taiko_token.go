...
func (_TaikoToken *TaikoTokenFilterer) FilterAddressManagerChanged(opts *bind.FilterOpts) (*TaikoTokenAddressManagerChangedIterator, error) {

	logs, sub, err := _TaikoToken.contract.FilterLogs(opts, "AddressManagerChanged")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event AddressManagerChanged(address addressManager)
func (_TaikoToken *TaikoTokenFilterer) WatchAddressManagerChanged(opts *bind.WatchOpts, sink chan<- *TaikoTokenAddressManagerChanged) (event.Subscription, error) {

	logs, sub, err := _TaikoToken.contract.WatchLogs(opts, "AddressManagerChanged")
	if err != nil {
		return nil, err
	}
...
// TaikoTokenBurnIterator is returned from FilterBurn and is used to iterate over the raw logs and unpacked data for Burn events raised by the TaikoToken contract.
type TaikoTokenBurnIterator struct {
	Event *TaikoTokenBurn // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TaikoTokenBurnIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TaikoTokenBurnIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TaikoTokenBurnIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TaikoTokenBurn represents a Burn event raised by the TaikoToken contract.
type TaikoTokenBurn struct {
...
func (_TaikoToken *TaikoTokenFilterer) FilterBurn(opts *bind.FilterOpts) (*TaikoTokenBurnIterator, error) {

	logs, sub, err := _TaikoToken.contract.FilterLogs(opts, "Burn")
	if err != nil {
		return nil, err
	}
	return &TaikoTokenBurnIterator{contract: _TaikoToken.contract, event: "Burn", logs: logs, sub: sub}, nil
}

// WatchBurn is a free log subscription operation binding the contract event 0xcc16f5dbb4873280815c1ee09dbd06736cffcc184412cf7a71a0fdb75d397ca5.
//
// Solidity: event Burn(address account, uint256 amount)
func (_TaikoToken *TaikoTokenFilterer) WatchBurn(opts *bind.WatchOpts, sink chan<- *TaikoTokenBurn) (event.Subscription, error) {

	logs, sub, err := _TaikoToken.contract.WatchLogs(opts, "Burn")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TaikoTokenBurn)
				if err := _TaikoToken.contract.UnpackLog(event, "Burn", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Burn(address account, uint256 amount)
func (_TaikoToken *TaikoTokenFilterer) ParseBurn(log types.Log) (*TaikoTokenBurn, error) {
	event := new(TaikoTokenBurn)
	if err := _TaikoToken.contract.UnpackLog(event, "Burn", log); err != nil {
		return nil, err
	}
...
// TaikoTokenMintIterator is returned from FilterMint and is used to iterate over the raw logs and unpacked data for Mint events raised by the TaikoToken contract.
type TaikoTokenMintIterator struct {
	Event *TaikoTokenMint // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TaikoTokenMintIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TaikoTokenMintIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TaikoTokenMintIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TaikoTokenMint represents a Mint event raised by the TaikoToken contract.
type TaikoTokenMint struct {
	Account common.Address
	Amount  *big.Int
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_TaikoToken *TaikoTokenFilterer) FilterMint(opts *bind.FilterOpts) (*TaikoTokenMintIterator, error) {

	logs, sub, err := _TaikoToken.contract.FilterLogs(opts, "Mint")
	if err != nil {
		return nil, err
	}
	return &TaikoTokenMintIterator{contract: _TaikoToken.contract, event: "Mint", logs: logs, sub: sub}, nil
}

// WatchMint is a free log subscription operation binding the contract event 0x0f6798a560793a54c3bcfe86a93cde1e73087d944c0ea20544137d4121396885.
//
// Solidity: event Mint(address account, uint256 amount)
func (_TaikoToken *TaikoTokenFilterer) WatchMint(opts *bind.WatchOpts, sink chan<- *TaikoTokenMint) (event.Subscription, error) {

	logs, sub, err := _TaikoToken.contract.WatchLogs(opts, "Mint")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TaikoTokenMint)
				if err := _TaikoToken.contract.UnpackLog(event, "Mint", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Mint(address account, uint256 amount)
func (_TaikoToken *TaikoTokenFilterer) ParseMint(log types.Log) (*TaikoTokenMint, error) {
	event := new(TaikoTokenMint)
	if err := _TaikoToken.contract.UnpackLog(event, "Mint", log); err != nil {
		return nil, err
	}
