...
//
// Solidity: function hashAssignment((address,uint64,uint64,uint64,bytes32,(uint16,uint128)[],bytes) assignment, address taikoL1Address, bytes32 blobHash) view returns(bytes32)
