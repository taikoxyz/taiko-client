...
//
// Solidity: function getBasefee(uint32 timeSinceNow, uint64 gasLimit, uint64 parentGasUsed) view returns(uint64 _basefee)
func (_TaikoL2Client *TaikoL2ClientCaller) GetBasefee(opts *bind.CallOpts, timeSinceNow uint32, gasLimit uint64, parentGasUsed uint64) (uint64, error) {
	var out []interface{}
...
//
// Solidity: function getBasefee(uint32 timeSinceNow, uint64 gasLimit, uint64 parentGasUsed) view returns(uint64 _basefee)
func (_TaikoL2Client *TaikoL2ClientSession) GetBasefee(timeSinceNow uint32, gasLimit uint64, parentGasUsed uint64) (uint64, error) {
...
//
// Solidity: function getBasefee(uint32 timeSinceNow, uint64 gasLimit, uint64 parentGasUsed) view returns(uint64 _basefee)
func (_TaikoL2Client *TaikoL2ClientCallerSession) GetBasefee(timeSinceNow uint32, gasLimit uint64, parentGasUsed uint64) (uint64, error) {
	return _TaikoL2Client.Contract.GetBasefee(&_TaikoL2Client.CallOpts, timeSinceNow, gasLimit, parentGasUsed)
}
