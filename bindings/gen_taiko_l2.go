...
func (_TaikoL2Client *TaikoL2ClientCaller) GetBasefee(opts *bind.CallOpts, l1BlockId uint64, parentGasUsed uint32) (*big.Int, error) {
	var out []interface{}
	err := _TaikoL2Client.contract.Call(opts, &out, "getBasefee", l1BlockId, parentGasUsed)
...
//
// Solidity: function getBasefee(uint64 l1BlockId, uint32 parentGasUsed) view returns(uint256 basefee)
func (_TaikoL2Client *TaikoL2ClientSession) GetBasefee(l1BlockId uint64, parentGasUsed uint32) (*big.Int, error) {
	return _TaikoL2Client.Contract.GetBasefee(&_TaikoL2Client.CallOpts, l1BlockId, parentGasUsed)
}

// GetBasefee is a free data retrieval call binding the contract method 0xa7e022d1.
//
// Solidity: function getBasefee(uint64 l1BlockId, uint32 parentGasUsed) view returns(uint256 basefee)
func (_TaikoL2Client *TaikoL2ClientCallerSession) GetBasefee(l1BlockId uint64, parentGasUsed uint32) (*big.Int, error) {
	return _TaikoL2Client.Contract.GetBasefee(&_TaikoL2Client.CallOpts, l1BlockId, parentGasUsed)
}
...
func (_TaikoL2Client *TaikoL2ClientTransactor) Anchor(opts *bind.TransactOpts, l1BlockHash [32]byte, l1StateRoot [32]byte, l1BlockId uint64, parentGasUsed uint32) (*types.Transaction, error) {
	return _TaikoL2Client.contract.Transact(opts, "anchor", l1BlockHash, l1StateRoot, l1BlockId, parentGasUsed)
}

// Anchor is a paid mutator transaction binding the contract method 0xda69d3db.
//
// Solidity: function anchor(bytes32 l1BlockHash, bytes32 l1StateRoot, uint64 l1BlockId, uint32 parentGasUsed) returns()
func (_TaikoL2Client *TaikoL2ClientSession) Anchor(l1BlockHash [32]byte, l1StateRoot [32]byte, l1BlockId uint64, parentGasUsed uint32) (*types.Transaction, error) {
	return _TaikoL2Client.Contract.Anchor(&_TaikoL2Client.TransactOpts, l1BlockHash, l1StateRoot, l1BlockId, parentGasUsed)
}

// Anchor is a paid mutator transaction binding the contract method 0xda69d3db.
//
// Solidity: function anchor(bytes32 l1BlockHash, bytes32 l1StateRoot, uint64 l1BlockId, uint32 parentGasUsed) returns()
func (_TaikoL2Client *TaikoL2ClientTransactorSession) Anchor(l1BlockHash [32]byte, l1StateRoot [32]byte, l1BlockId uint64, parentGasUsed uint32) (*types.Transaction, error) {
	return _TaikoL2Client.Contract.Anchor(&_TaikoL2Client.TransactOpts, l1BlockHash, l1StateRoot, l1BlockId, parentGasUsed)
}
...
func (_TaikoL2Client *TaikoL2ClientTransactor) OnMessageInvocation(opts *bind.TransactOpts, data []byte) (*types.Transaction, error) {
	return _TaikoL2Client.contract.Transact(opts, "onMessageInvocation", data)
}

// OnMessageInvocation is a paid mutator transaction binding the contract method 0x7f07c947.
//
// Solidity: function onMessageInvocation(bytes data) payable returns()
func (_TaikoL2Client *TaikoL2ClientSession) OnMessageInvocation(data []byte) (*types.Transaction, error) {
	return _TaikoL2Client.Contract.OnMessageInvocation(&_TaikoL2Client.TransactOpts, data)
}

// OnMessageInvocation is a paid mutator transaction binding the contract method 0x7f07c947.
//
// Solidity: function onMessageInvocation(bytes data) payable returns()
func (_TaikoL2Client *TaikoL2ClientTransactorSession) OnMessageInvocation(data []byte) (*types.Transaction, error) {
	return _TaikoL2Client.Contract.OnMessageInvocation(&_TaikoL2Client.TransactOpts, data)
}
