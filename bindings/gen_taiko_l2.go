...
func (_TaikoL2Client *TaikoL2ClientCaller) LastSnapshotIdx(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _TaikoL2Client.contract.Call(opts, &out, "lastSnapshotIdx")
...
//
// Solidity: function lastSnapshotIdx() view returns(uint32)
func (_TaikoL2Client *TaikoL2ClientSession) LastSnapshotIdx() (uint32, error) {
	return _TaikoL2Client.Contract.LastSnapshotIdx(&_TaikoL2Client.CallOpts)
}

// LastSnapshotIdx is a free data retrieval call binding the contract method 0x1da5b924.
//
// Solidity: function lastSnapshotIdx() view returns(uint32)
func (_TaikoL2Client *TaikoL2ClientCallerSession) LastSnapshotIdx() (uint32, error) {
	return _TaikoL2Client.Contract.LastSnapshotIdx(&_TaikoL2Client.CallOpts)
}
...
// TaikoL2ClientTaikoTokenSnapshotIterator is returned from FilterTaikoTokenSnapshot and is used to iterate over the raw logs and unpacked data for TaikoTokenSnapshot events raised by the TaikoL2Client contract.
type TaikoL2ClientTaikoTokenSnapshotIterator struct {
	Event *TaikoL2ClientTaikoTokenSnapshot // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TaikoL2ClientTaikoTokenSnapshotIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TaikoL2ClientTaikoTokenSnapshot)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TaikoL2ClientTaikoTokenSnapshotIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TaikoL2ClientTaikoTokenSnapshotIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TaikoL2ClientTaikoTokenSnapshot represents a TaikoTokenSnapshot event raised by the TaikoL2Client contract.
type TaikoL2ClientTaikoTokenSnapshot struct {
...
func (_TaikoL2Client *TaikoL2ClientFilterer) FilterTaikoTokenSnapshot(opts *bind.FilterOpts) (*TaikoL2ClientTaikoTokenSnapshotIterator, error) {

	logs, sub, err := _TaikoL2Client.contract.FilterLogs(opts, "TaikoTokenSnapshot")
	if err != nil {
		return nil, err
	}
	return &TaikoL2ClientTaikoTokenSnapshotIterator{contract: _TaikoL2Client.contract, event: "TaikoTokenSnapshot", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TaikoTokenSnapshot(address tkoAddress, uint256 snapshotIdx, uint256 snapshotId)
func (_TaikoL2Client *TaikoL2ClientFilterer) WatchTaikoTokenSnapshot(opts *bind.WatchOpts, sink chan<- *TaikoL2ClientTaikoTokenSnapshot) (event.Subscription, error) {

	logs, sub, err := _TaikoL2Client.contract.WatchLogs(opts, "TaikoTokenSnapshot")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TaikoL2ClientTaikoTokenSnapshot)
				if err := _TaikoL2Client.contract.UnpackLog(event, "TaikoTokenSnapshot", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TaikoTokenSnapshot(address tkoAddress, uint256 snapshotIdx, uint256 snapshotId)
func (_TaikoL2Client *TaikoL2ClientFilterer) ParseTaikoTokenSnapshot(log types.Log) (*TaikoL2ClientTaikoTokenSnapshot, error) {
	event := new(TaikoL2ClientTaikoTokenSnapshot)
	if err := _TaikoL2Client.contract.UnpackLog(event, "TaikoTokenSnapshot", log); err != nil {
		return nil, err
	}
...
// TaikoL2ClientTaikoTokenSnapshot0Iterator is returned from FilterTaikoTokenSnapshot0 and is used to iterate over the raw logs and unpacked data for TaikoTokenSnapshot0 events raised by the TaikoL2Client contract.
type TaikoL2ClientTaikoTokenSnapshot0Iterator struct {
	Event *TaikoL2ClientTaikoTokenSnapshot0 // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TaikoL2ClientTaikoTokenSnapshot0Iterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TaikoL2ClientTaikoTokenSnapshot0)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TaikoL2ClientTaikoTokenSnapshot0Iterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TaikoL2ClientTaikoTokenSnapshot0Iterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TaikoL2ClientTaikoTokenSnapshot0 represents a TaikoTokenSnapshot0 event raised by the TaikoL2Client contract.
type TaikoL2ClientTaikoTokenSnapshot0 struct {
	TkoAddress  common.Address
	SnapshotIdx *big.Int
	SnapshotId  *big.Int
	Raw         types.Log // Blockchain specific contextual infos
...
//
// Solidity: event TaikoTokenSnapshot(address tkoAddress, uint256 snapshotIdx, uint256 snapshotId)
func (_TaikoL2Client *TaikoL2ClientFilterer) FilterTaikoTokenSnapshot0(opts *bind.FilterOpts) (*TaikoL2ClientTaikoTokenSnapshot0Iterator, error) {

	logs, sub, err := _TaikoL2Client.contract.FilterLogs(opts, "TaikoTokenSnapshot0")
	if err != nil {
		return nil, err
	}
	return &TaikoL2ClientTaikoTokenSnapshot0Iterator{contract: _TaikoL2Client.contract, event: "TaikoTokenSnapshot0", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TaikoTokenSnapshot(address tkoAddress, uint256 snapshotIdx, uint256 snapshotId)
func (_TaikoL2Client *TaikoL2ClientFilterer) WatchTaikoTokenSnapshot0(opts *bind.WatchOpts, sink chan<- *TaikoL2ClientTaikoTokenSnapshot0) (event.Subscription, error) {

	logs, sub, err := _TaikoL2Client.contract.WatchLogs(opts, "TaikoTokenSnapshot0")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TaikoL2ClientTaikoTokenSnapshot0)
				if err := _TaikoL2Client.contract.UnpackLog(event, "TaikoTokenSnapshot0", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TaikoTokenSnapshot(address tkoAddress, uint256 snapshotIdx, uint256 snapshotId)
func (_TaikoL2Client *TaikoL2ClientFilterer) ParseTaikoTokenSnapshot0(log types.Log) (*TaikoL2ClientTaikoTokenSnapshot0, error) {
	event := new(TaikoL2ClientTaikoTokenSnapshot0)
	if err := _TaikoL2Client.contract.UnpackLog(event, "TaikoTokenSnapshot0", log); err != nil {
		return nil, err
	}
