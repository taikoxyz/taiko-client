...
func (_TaikoL2Client *TaikoL2ClientCaller) GetBasefee(opts *bind.CallOpts, timeSinceParent uint32, gasLimit uint32, parentGasUsed uint32) (*big.Int, error) {
	var out []interface{}
	err := _TaikoL2Client.contract.Call(opts, &out, "getBasefee", timeSinceParent, gasLimit, parentGasUsed)
...
//
// Solidity: function getBasefee(uint32 timeSinceParent, uint32 gasLimit, uint32 parentGasUsed) view returns(uint256 _basefee)
func (_TaikoL2Client *TaikoL2ClientSession) GetBasefee(timeSinceParent uint32, gasLimit uint32, parentGasUsed uint32) (*big.Int, error) {
	return _TaikoL2Client.Contract.GetBasefee(&_TaikoL2Client.CallOpts, timeSinceParent, gasLimit, parentGasUsed)
}

// GetBasefee is a free data retrieval call binding the contract method 0xc20ebea5.
//
// Solidity: function getBasefee(uint32 timeSinceParent, uint32 gasLimit, uint32 parentGasUsed) view returns(uint256 _basefee)
func (_TaikoL2Client *TaikoL2ClientCallerSession) GetBasefee(timeSinceParent uint32, gasLimit uint32, parentGasUsed uint32) (*big.Int, error) {
	return _TaikoL2Client.Contract.GetBasefee(&_TaikoL2Client.CallOpts, timeSinceParent, gasLimit, parentGasUsed)
}
...
func (_TaikoL2Client *TaikoL2ClientFilterer) FilterAddressManagerChanged(opts *bind.FilterOpts) (*TaikoL2ClientAddressManagerChangedIterator, error) {
	...
	logs, sub, err := _TaikoL2Client.contract.FilterLogs(opts, "AddressManagerChanged")
	if err != nil {
		return nil, err
	}
...
func (_TaikoL2Client *TaikoL2ClientFilterer) WatchAddressManagerChanged(opts *bind.WatchOpts, sink chan<- *TaikoL2ClientAddressManagerChanged) (event.Subscription, error) {
	...
	logs, sub, err := _TaikoL2Client.contract.WatchLogs(opts, "AddressManagerChanged")
	if err != nil {
		return nil, err
	}
